...
// Generates the AppIcon.iconset (all sizes) for Key54. (The README/site icon,
// docs/icon.png, is a committed one-off — tweaking the art here does NOT
// regenerate it.) The icon *is* a MacBook-style keycap —
